...
end_minute_bar = f"{today} 14:00:00+00:00"
...
for symbol in symbols:
    ...
    operning_range_low = opening_range_bars['low'].min()
    opening_range_high = opening_range_bars['high'].max()
    opening_range = opening_range_high - operning_range_low
    print(symbol)
    print(opening_range_bars)
    print(opening_range)
    print(opening_range_high)
    print(operning_range_low)
